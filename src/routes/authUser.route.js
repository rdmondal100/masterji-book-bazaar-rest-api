...
import { apiKeyValidator, userLoginValidator, userRegisterValidator } from "../validators/authUser.validate.js";
...
authUserRouter.route("/api-key").post(apiKeyValidator(),checkIsAuthenticated,generateNewAPIKey)
